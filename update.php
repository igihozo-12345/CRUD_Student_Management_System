...
<body>
    ...
    <div class="nav2">
        <?php
        $id=$_GET['id'];
        $select="SELECT * FROM add_student WHERE id=$id";
...
if(isset($_POST['update'])){
    ...
    $id=$_GET['id'];
    $update="UPDATE add_student SET firstname='$firstname',lastname='$lastname',dob='$dob',gender='$gender', address='$address',department='$department' WHERE id='$id'";
